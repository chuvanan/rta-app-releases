...
releases <- read.csv("~/Documents/rta-app-releases/releases-note.csv",
...
png("~/Documents/rta-app-releases/rtwork-release-cycle.png", 1076, 673, res = 100)
...
mtext("rtWork (rtCpms) release cycle is getting shorter and more regular", adj = 0, font = 2)
mtext("builds", side = 2, line = 4, cex = 0.9)
arrows(as.Date("2016-05-27"), 22, as.Date("2016-09-13"), 22,
       length = 0.05, code = 3, col = "gray30")
text(as.Date("2016-07-20"), 26, labels = "Time it takes to level\nup ~10 versions",
     cex = 0.8, col = "gray30")
abline(v = as.Date("2016-09-13"), col = "red4")
text(as.Date("2016-07-20"), 65, labels = "Change in\nrelease policy?",
     cex = 0.8, col = "gray30")
